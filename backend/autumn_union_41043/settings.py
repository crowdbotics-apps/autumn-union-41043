"""
Django settings for autumn_union_41043 project.
...
ROOT_URLCONF = 'autumn_union_41043.urls'
...
WSGI_APPLICATION = 'autumn_union_41043.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "autumn_union_41043 API",
    "DESCRIPTION": "API documentation for autumn_union_41043 App",
    "VERSION": "v1",
}
